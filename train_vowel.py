...
def get_indices(train):
    OK = {13, 14, 15, 16, 17, 18, 21, 22, 23, 25, 29, 31, 32, 36,
          38, 40, 42, 43, 44, 48, 50, 52, 53, 55, 56, 58, 59, 62,
          64, 65, 66, 69, 70, 71, 72, 74, 75, 76, 77, 79, 81, 83,
          85, 86, 88, 89, 91, 92, 94, 95, 96, 101, 103, 107, 109,
          112, 113, 115, 117, 118, 119, 120, 122, 123, 124, 125,
          127, 128, 129, 132, 133, 138, 139, 140, 141, 142, 147,
          148, 149, 150, 151, 153, 154, 155, 156, 159, 165, 167}
...
def main(args):
    ...
    train_image = GraphemeDataset(train_data,
                                  reduced_train.vowel_diacritic.values,
                                  'train')
